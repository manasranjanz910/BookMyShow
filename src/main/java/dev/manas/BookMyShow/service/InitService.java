...
import dev.manas.BookMyShow.model.*;
...
import dev.manas.BookMyShow.repository.*;
...
public class InitService {
    ...
    public boolean initialise(){
        ...
        for(int i=1;i<=5;i++){
            Seat s = new Seat(i, i,SeatType.GOLD ,SeatStatus.READYTOUSE,i+ " "+i);
        ...
        for(int i=1;i<=5;i++){
            ShowSeat s = new ShowSeat( showRepository.findById(1).get(),seatRepository.findSeatBySeatNumber(i+" "+i),ShowSeatStatus.AVAILABLE);
